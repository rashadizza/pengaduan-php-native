	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#user_edit<?php echo $r['id_petugas'] ?>">Edit</a> <a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" href="index.php?p=user_hapus&id_petugas=<?php echo $r['id_petugas'] ?>">Hapus</a></td>
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------ -->
        ...
        <div id="modal1" class="modal">
          ...
          <div class="modal-footer">
            <a href="#!" class="modal waves-effect waves-green btn-flat"></a>
          </div>
        </div>

		<div class="col s12 m3">
            <div class="section"></div>
            <a class="waves-effect waves-light btn modal-trigger blue" href="#modal1">Tambah data</a>
        </div>